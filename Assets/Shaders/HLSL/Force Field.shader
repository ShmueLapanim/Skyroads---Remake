Shader "Ultimate 10+ Shaders/Force Field Flash"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.rim = saturate(pow(rawRim, _FresnelPower) + 0.1);
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // Glow pulse
                float glowFactor = sin(_Time.y * _GlowSpeed) * 0.5 + 0.5; // range 0..1
                glowFactor *= _GlowStrength;

                tex.rgb += _GlowColor.rgb * glowFactor;
